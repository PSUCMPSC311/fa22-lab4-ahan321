...
int test_cache_lfu_insert();
int test_cache_lfu_lookup();
...
int main(int argc, char *argv[])
{
  ...
  score += test_cache_lfu_insert();
  score += test_cache_lfu_lookup();
...
/* Testing LFU in the case of insert-only workload. We insert 4 entries to a
...
/* Testing LFU in the case of a workload with inserts and lookups. We insert 3
